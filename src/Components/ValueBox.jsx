...
function ValueBox({ direction }) {
  ...
  return (
    <div className="rounded-2xl bg-neutral-700 p-2.5 sm:p-3">
      ...
      <div className="flex items-end justify-between">
        <input
          ...
          type="text"
          accept="0123456789"
          className={`h-16 w-full bg-transparent text-3xl font-bold text-neutral-100 focus:border-none focus:outline-none disabled:text-lime-500 sm:h-15 sm:text-4xl`}
        />
